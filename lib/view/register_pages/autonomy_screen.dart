...
import '../../controllers/autonomy_level_controller.dart';

import '../utils/dialog.dart';
import '../utils/form_pagelogs.dart';
...
class Autonomyedite extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) {
        return AutonomilevelControler(registerStore: person ?? RegisterStore());
      },
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          _CardFormAutonomy('Nivel',
                                              state.controllerNameNivel),
                                          _CardFormAutonomy(
